      ...
      <main className="container mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          ...
          <section className="mb-12">
            ...
            >
              <p>
                Get reliable washing machine repair services to keep your
                laundry routine running smoothly. Our experienced technicians
                specialize in diagnosing and fixing all types of washing machine
                issues, ensuring efficient and lasting solutions for your home
                or business.
              </p>
              <p>
                Whether it’s water leakage, drum malfunctions, unusual noises,
                or power failures, we are here to help. We service all major
                washing machine brands and models, offering prompt and
                affordable repairs that you can trust.
              </p>
              <p>
                Customer satisfaction is our priority. We provide quick
                turnarounds, transparent pricing, and exceptional service to
                ensure your washing machine performs at its best.
              </p>
            </motion.div>
          </section>
          ...
          <section className="mb-12 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRi8Vpq-0giXn7Wozeq410tqe57nTx42Fi8oA&s"
            ...
            >
              <img
                src="https://static.wixstatic.com/media/ade29c_deee882beec34abfa55062ac09169d0d~mv2.jpg/v1/fill/w_555,h_365,fp_0.50_0.50,lg_1,q_80,enc_auto/ade29c_deee882beec34abfa55062ac09169d0d~mv2.jpg"
          ...
          <section className="mb-12">
            ...
            >
              <p>
                We use a systematic approach to resolve your washing machine
                issues effectively:
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                {[
                  ...
                  "Fixing water drainage and pump issues",
                  "Repairing or replacing faulty drums",
                  "Addressing electrical and motor problems",
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Regular washing machine maintenance can prevent major breakdowns
                and extend the life of your appliance. Our maintenance services
                include thorough cleaning, component checks, and performance
                optimization.
              </motion.p>
            </motion.div>
          </section>
          ...
          <section className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-4">
            {[3, 4, 5].map((num) => (
              ...
              >
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcbUS-3SBDdP7-gmEf8XQXjLc53QJUxuEfNw&s"
          ...
          <section className="mb-12">
            ...
            >
              <p className="text-lg text-gray-700">
                Trust our skilled technicians to provide high-quality washing
                machine repair services tailored to meet your specific needs.
